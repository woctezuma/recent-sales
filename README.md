...
* code (`list_daily_releases.py`) to evaluate [sales and revenue](https://github.com/woctezuma/recent-sales/blob/master/output.txt) generated by Steam games during the week following the release. This requires to download SteamSpy's data (`download_json.py`) everyday for a little while before being able to perform any analysis.
